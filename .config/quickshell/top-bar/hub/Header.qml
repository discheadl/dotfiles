...
Item {
  ...
  readonly property color _textOnAccent:     theme ? theme.textOnAccent     : "#232a2e"
  ...
  Timer {
    ...
    interval: 320
    repeat: false
    onTriggered: Quickshell.execDetached(["bash", "-c", "/home/dischead/.config/hypr/screenshots/captureArea.sh"])
  }
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    border.width: 1
                    border.color: Qt.rgba(root._textPrimary.r, root._textPrimary.g, root._textPrimary.b, 0.35)
                ...
                Rectangle {
                    id: pwrBtn
                    width: 24; height: 24; radius: 12
                    readonly property bool _active: pwrHover.hovered || root.expanded || pwrTap.pressed
                    color: _active
                        ? root._accentRed
                        : Qt.rgba(root._accentRed.r, root._accentRed.g, root._accentRed.b, 0.22)
                    border.width: 1
                    border.color: Qt.rgba(root._accentRed.r, root._accentRed.g, root._accentRed.b, _active ? 1.0 : 0.70)
                    ...
                    Text {
                      ...
                      font.pixelSize: 12
                      font.weight: 800
                      // Active: high-contrast text on the red fill.
                      // Inactive: primary text colour so the glyph stays
                      // readable regardless of which wallust slot accentRed
                      // resolves to on the current wallpaper.
                      color: pwrBtn._active ? root._textOnAccent : root._textPrimary
                    }
